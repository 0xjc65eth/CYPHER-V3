...
export function middleware(request: NextRequest) {
  ...
  response.headers.set(
    ...
    [
      ...
      "connect-src 'self' https://cypherordifuture.xyz https://*.vercel.app https://api.coingecko.com https://pro-api.coingecko.com https://mempool.space https://api.hiro.so https://api-mainnet.magiceden.dev https://open-api.unisat.io https://api.bestinslot.xyz https://api.hyperliquid.xyz https://api.binance.com https://data-api.binance.vision https://api.coinbase.com https://api.kraken.com https://api.bybit.com https://www.okx.com https://api-pub.bitfinex.com https://api.kucoin.com https://api.gateio.ws https://api.alternative.me wss://stream.binance.com wss://ws-feed.exchange.coinbase.com",
      "font-src 'self' data:",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
