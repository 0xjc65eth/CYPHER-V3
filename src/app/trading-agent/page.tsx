      ...
      <div className="border-b border-orange-500/30 bg-[#0a0a0a]">
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-[10px] text-orange-500/60 font-mono tracking-wider">CYPHER TRADING AGENT</div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div>
                <div className="text-[10px] text-orange-500/60 font-mono tracking-wider">CYPHER AI</div>
                <h1 className="text-lg font-bold text-orange-400 font-mono">TRADING AGENT</h1>
              </div>
