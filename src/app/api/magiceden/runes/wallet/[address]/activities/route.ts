...
export async function GET(
  ...
  try {
    ...
    const data = await magicEdenRunesService.getWalletRuneActivities(activityParams);
    return NextResponse.json(data);
  } catch (error) {
    console.error('[API] GET /api/magiceden/runes/wallet/[address]/activities error:', error);
    return NextResponse.json(
